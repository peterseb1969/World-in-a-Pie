...
declare class DefStoreService extends BaseService {
    ...
    getParents(termId: string, namespace: string): Promise<TermRelation[]>;
    getChildren(termId: string, namespace: string): Promise<TermRelation[]>;
