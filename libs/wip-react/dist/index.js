...
// src/provider.tsx
var WipClientContext = createContext(null);
function WipProvider({ client, children }) {
  return /* @__PURE__ */ jsx(WipClientContext.Provider, { value: client, children });
}
...
function WipFooter({
  ...
  return /* @__PURE__ */ jsx("footer", { className: joinClassNames(WRAPPER_BASE, className), style, "data-wip-footer-variant": variant, children: /* @__PURE__ */ jsxs("div", { className: INNER, children: [
    /* @__PURE__ */ jsxs(
      "svg",
      {
        viewBox: "0 0 100 100",
        ...
        focusable: "false",
        children: [
          /* @__PURE__ */ jsx("path", { d: "M50 50 L90 50 A40 40 0 0 1 74 82 L26 82 A40 40 0 0 1 50 10 Z", fill: "#2B579A" }),
          /* @__PURE__ */ jsx("rect", { x: "5", y: "86", width: "90", height: "6", rx: "3", fill: "#2B579A" })
        ]
      }
    ),
    /* @__PURE__ */ jsx("span", { children: text }),
    buildText ? /* @__PURE__ */ jsx("span", { className: "opacity-60", "data-wip-build-stamp": true, title: "Build of the running image", children: `\xB7 ${buildText}` }) : null
  ] }) });
}
...
function useBulkImport(options) {
  ...
  const mutation = useMutation({
    mutationFn: (items) => bulkImport(items, options.writeFn, {
