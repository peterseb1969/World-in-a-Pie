...
export const useTerminologyStore = defineStore('terminology', () => {
  ...
  async function fetchTerminologies(params?: {
    ...
    error.value = null
    try {
      const response = await apiClient.listTerminologies(params)
  ...
  async function fetchTerminology(id: string) {
    ...
    error.value = null
    try {
      currentTerminology.value = await apiClient.getTerminology(id)
  ...
  async function createTerminology(data: CreateTerminologyRequest) {
    ...
    error.value = null
    try {
      const created = await apiClient.createTerminology(data)
  ...
  async function updateTerminology(id: string, data: UpdateTerminologyRequest) {
    ...
    error.value = null
    try {
      const updated = await apiClient.updateTerminology(id, data)
  ...
  async function deleteTerminology(id: string) {
    ...
    error.value = null
    try {
      await apiClient.deleteTerminology(id)
