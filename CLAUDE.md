...
- MCP server — 43 tools for AI-assisted development, 3 resources (conventions, data model, development guide), OpenAPI schema patching, stdio + SSE transport
...
| 5 | MCP Server | ✅ Complete — 43 tools, 3 resources, OpenAPI schema patching, stdio + SSE transport |
...
│   ├── mcp-server/        # MCP server — 43 tools for AI-assisted development (stdio + SSE)
