...
echo "  To rebuild:  wip-deploy rebuild <service>   (per-service rebuild)"
echo "  Full setup:  wip-deploy install --target dev --hostname localhost"
echo "  Tear down:   wip-deploy nuke --remove-data  (containers + volumes)"
echo "=========================================="
